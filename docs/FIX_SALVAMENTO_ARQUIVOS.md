...
if (configPastas && configPastas.unidade && configPastas.unidade.abreviacao) {
  ...
  console.warn('[FS] ⚠️ Usando estrutura padrão: IFDESK');
}
```
...
```
[Pasta Selecionada]/
└── IFDESK/              ← Padrão (ou abreviação configurada)
...
4. Verificar `ifdesk_test.txt` na pasta
...
[FS] ⚠️ Estrutura de pastas não configurada - usando padrão: IFDESK
[FS] 📁 Criando estrutura: IFDESK/2024/Notas de Empenho
[FS] ✅ Pasta unidade criada: IFDESK
[FS] ✅ Pasta ano criada: 2024
[FS] ✅ Pasta tipo criada: Notas de Empenho
[FS] ✅ Estrutura completa criada: IFDESK/2024/Notas de Empenho
...
[FS] 📁 Caminho: IFDESK/2024/Notas de Empenho/NE 48 GGV COMERCIO.pdf
...
📁 IFDESK/
   📁 2024/
      📁 Notas de Empenho/
         ...
         📄 ifdesk_test.txt         ← Arquivo de teste
```
...
**Mudança:** Usa valor padrão `'IFDESK'` se não houver configuração

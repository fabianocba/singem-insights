...
├── NAVEGACAO.md                   ├── 📁 css/
├── RELATORIO_LIMPEZA.md          ├── 📁 data/
├── LIMPEZA_EXECUTADA.md          ├── 📁 docs/
├── SUMARIO_LIMPEZA.md            ├── 📁 img/
├── IFDESK.code-workspace         ├── 📁 js/
...
- ✅ `IFDESK.code-workspace` → `config/IFDESK.code-workspace`
...
- ✅ `RELATORIO_LIMPEZA.md` → `docs/RELATORIO_LIMPEZA.md`

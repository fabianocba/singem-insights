...
router.post('/contas-contabeis', authenticate, requirePermission('gestao_almoxarifado', 'CADASTRAR'), validate(createContaContabilSchema), controller.createConta);
...
router.post('/itens', authenticate, requirePermission('gestao_almoxarifado', 'CADASTRAR'), validate(createItemSchema), controller.createItem);
router.put('/itens/:id', authenticate, requirePermission('gestao_almoxarifado', 'EDITAR'), validate(updateItemSchema), controller.updateItem);

router.get('/notas-entrada', authenticate, validate(listNotasEntradaSchema), controller.listNotasEntrada);
router.post('/notas-entrada', authenticate, requirePermission('gestao_almoxarifado', 'CADASTRAR'), validate(createNotaEntradaSchema), controller.createNotaEntrada);

router.get('/movimentacoes', authenticate, validate(listMovimentacoesSchema), controller.listMovimentacoes);
router.post('/movimentacoes', authenticate, requirePermission('gestao_almoxarifado', 'CADASTRAR'), validate(createMovimentacaoSchema), controller.createMovimentacao);

router.get('/solicitacoes', authenticate, validate(listSolicitacoesSchema), controller.listSolicitacoes);
router.post('/solicitacoes', authenticate, requirePermission('gestao_almoxarifado', 'CADASTRAR'), validate(createSolicitacaoSchema), controller.createSolicitacao);
router.patch(
